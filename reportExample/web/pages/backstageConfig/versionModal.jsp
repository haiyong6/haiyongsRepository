<%@page import="com.ways.app.backstageConfig.model.Version"%>
<%@page import="com.ways.framework.utils.AppFrameworkUtil"%>
...
<div class="letterContainer">
	...
	<div style="height: 250px; overflow: auto;" id="test" class="letterContentContainer">
		<table cellpadding="0" cellspacing="0" border="1" width="100%" class="selectorTable bpTable">
			<thead>
				<tr>
					<th>车型</th>
					<th>MSRP</th>
