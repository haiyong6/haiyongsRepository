...
<div>
	<div class="resultShowContainer">
		<div class="resultShowContent" style="background-color:#fff;height:50px;overflow: auto;" id="selectorResultContainerBySubModel2" >
			
		</div>
	</div>
	<ul class="nav nav-tabs">
		<li class="active">
			<a href="#tabs-brand2" data-toggle="tab" value="3" onclick="showSubModel2('3', '1')" >品牌</a>
		</li>
		<li>
			<a href="#tabs-manf2" data-toggle="tab" value="4" onclick="showSubModel2('4', '1')" >厂商</a>
		</li>
	...
	<div class="tab-content">
		<!-- 品牌——开始 -->
		<div class="tab-pane active" id="tabs-brand2" style="height:300px;overflow: auto;">
			<div class="letterContainer">
				...
				<div class="letterContentContainer" style="height: 250px; overflow: auto; " id="test">
						...
						<table cellpadding="0" cellspacing="0" border="1" width="100%" class="selectorTable" id="jpBrandTable" style="margin-bottom: 0px">
							<c:forEach items="${brandLetterList}" var="brandLetter">
								<tr>
		...
		<!-- 品牌——结束 -->
		<!-- 厂商——开始 -->
		<div class="tab-pane" id="tabs-manf2" style="height:300px;overflow: auto;">
