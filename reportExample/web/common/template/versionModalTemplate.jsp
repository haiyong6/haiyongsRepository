...
<div id="versionModal" class="modal hide versionModalContainer" style="width:700px; height: 560px; margin-left: -350px; margin-top: -50px;" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
