...
<div id="subModelModal" style="width:700px; height: 560px; margin-left: -350px; margin-top: -50px;" class="modal hide subModelModalContainer" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
