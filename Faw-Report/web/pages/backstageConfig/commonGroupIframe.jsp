...
<body>
<form id="commonGroupForm" method="post" action="${ctx}/backstageConfig/saveCommonGroup.do" style="margin-left: 20px;">
          <div style="margin-top: 0px;margin-bottom: 0px;">
     	     <table class="display cell-border" cellSpacing="0" width="100%" id="commonGroupTable">
   	          <tbody>
   		       <tr>
   		        <input type="hidden" id="groupId" name="groupId" />
   		        <td class="td1">分组名：</td>
   		        <td class="td2"><input type="text" id="commonGroupName" name="groupName" style="margin-left:20px;"/></td>
   		        <input type="hidden" id="oldGroupName" name="oldGroupName" />
   		        <td class="td1">分组排序：</td>
   		        <td class="td2"><input type="text" id="commonGroupSort" name="groupSort"/></td>
   		       </tr>
   		       <tr>
   		        <td class="td1">
				...
				<td class="td2">
				  ...
				  <div class="control-group" name = "objectType1">
					<div class="controls">
					  <div class="span2" style="width:90px;">
						 <a href="#versionModal" role="button" class="btn btn-small" data-toggle="modal">选择型号</a>
					  </div>
				 	  <div class="span4" style="margin-left:0px" id="versionModalResultContainer"></div>
				    </div>
				  </div>
   		        </td>
   		       </tr>
				...
				<td class="td2">
				  ...
				  <div class="control-group" name = "objectType1">
					<div class="controls">
					  <div class="span2" style="width:90px">
						 <a href="#versionModal2" role="button" class="btn btn-small" data-toggle="modal">选择型号</a>
					  </div>
				 	  <div class="span4" style="margin-left:0px" id="versionModalResultContainer2"></div>
				    </div>
				  </div>
   		        </td>
   		       </tr>
   		 ...
   		 <div>
   		    <input type="hidden" id="saveType" name="saveType"/>
   		   	<button type="button" id="confirmSubmit" onclick="addCommonGroup()">确认</button>&nbsp;&nbsp;
