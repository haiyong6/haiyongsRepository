...
<div id="commonGroupImport" style="width: 100%;height:180px;" aria-hidden="true" class="hide" tabindex="-1" role="dialog" aria-hidden="true">
   <div class="modal-body" style="margin:0px" id="subModelModalBody">
      <form action="${ctx}/basePeriodTPConfig/downloadCommonGroupTemplate.do" id="templateFormId" class="form-horizontal" style="margin-top:0px;display: inline;">
	  ...
	  <form action="${ctx}/basePeriodTPConfig/importCommonGroupFile.do" id="importFormId" class="form-horizontal" style="margin-top:0px;display: inline;"
